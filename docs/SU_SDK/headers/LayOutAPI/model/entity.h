...
@note Since LayOut 2026.1, API 11.1, this method returns
                     \ref SU_ERROR_INVALID_INPUT when \p transform_matrix is not invertible.
@return
- \ref SU_ERROR_NONE on success
- \ref SU_ERROR_INVALID_INPUT if entity does not refer to a valid object or
       \p transform_matrix is not invertible
