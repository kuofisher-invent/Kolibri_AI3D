...
impl SvgIconCache {
    ...
    pub fn preload_ribbon_icons(&mut self, ctx: &egui::Context) {
        let icons = [
            ...
            "text", "leader", "hatch", "table",
            "zoomall", "zoomwin",
            "print", "print_pdf", "export",
            "copy", "delete", "edit", "erase",
            "layer", "layer_properties", "layer_match", "layer_set_current", "layer_freeze",
            "grid", "snap",
            "block_create", "block_insert", "spline", "point", "stretch", "fillet",
            "break_tool", "join", "revcloud", "measure_dist", "measure_area",
            "match_prop", "quick_select", "list_info", "id_point",
            "center_mark", "lengthen", "ray",
        ];
        for name in &icons {
...
pub(crate) fn tool_icon_name(tool: crate::editor::Tool) -> Option<&'static str> {
    ...
    match tool {
        ...
        Tool::DraftErase => Some("erase"),
        Tool::DraftBreak => Some("break_tool"),
        Tool::DraftJoin => Some("join"),
        Tool::DraftRevcloud => Some("revcloud"),
        Tool::DraftTable => Some("table"),
        Tool::DraftLengthen => Some("lengthen"),
        Tool::DraftRay => Some("ray"),
        Tool::DraftMatchProp => Some("match_prop"),
        Tool::DraftMeasureDist => Some("measure_dist"),
        Tool::DraftMeasureArea => Some("measure_area"),
        Tool::DraftQuickSelect => Some("quick_select"),
        Tool::DraftList => Some("list_info"),
        Tool::DraftIdPoint => Some("id_point"),
        Tool::DraftCenterMark => Some("center_mark"),
        Tool::DraftLayerProp => Some("layer_properties"),
        Tool::DraftLayerMatch => Some("layer_match"),
        Tool::DraftMakeCurrent => Some("layer_set_current"),
        _ => None,
    }
}
